...
class WizardTestComponent {
  ...
  public wizardStepTestComponent: any;
...
class WizardStepTestComponent {
  constructor(@Host() private wizardStep: WizardStepDirective, wizard: WizardTestComponent) {
    wizardStep.stepEnter.emit = (direction:any) => wizard.enterInto(direction, 2);
    wizardStep.stepExit.emit = (direction:any) => wizard.exitFrom(direction, 2);
  }
}
